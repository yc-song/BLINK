...
echo "lr=${lr}"
python_output=$(python /home/jongsong/BLINK/blink/crossencoder/train_cross.py --data_path=models/zeshel_test/top64_candidates/ --learning_rate=${lr} --resume=True --run_id=$1 --num_train_epochs=${num_train_epochs} --train_batch_size 2 --eval_batch_size 8 --save True --train_size 10000 --valid_size 5000 --decoder=True --dim_red=768 --layers=4 --architecture mlp_with_bert)
echo $python_output
