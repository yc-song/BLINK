# python slurm_wandb_agent.py <sweep_id> -p wandb-tutorial -e <your wandb account name or team name> --num-jobs 5 -f --edit-sbatch --edit-srun
...
def main(args):
    ...
    file_str['srun.sh'] = "\n".join((
        "",
        f"wandb agent --count 1 {complete_sweep_id}",
