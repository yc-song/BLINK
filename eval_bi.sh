...
# echo${"mlp"}
python blink/biencoder/eval_biencoder.py --path_to_model /home/jongsong/BLINK/models/zeshel/biencoder_base/pytorch_model.bin --data_path data/zeshel/blink_format --output_path models/zeshel/w_scores_256 --encode_batch_size 256 --eval_batch_size 32 --top_k 256 --bert_model bert-base-cased --mode test --zeshel True --data_parallel True --architecture special_tokens --cand_encode_path data/zeshel/cand_enc_base/cand_enc_test.pt --cand_pool_path data/zeshel/cand_pool_base/cand_pool_test.pt --cand_cls_path data/zeshel/cand_enc_base/cand_enc_test_cls.pt --save_topk_result --split 2
python blink/biencoder/eval_biencoder.py --path_to_model /home/jongsong/BLINK/models/zeshel/biencoder_base/pytorch_model.bin --data_path data/zeshel/blink_format --output_path models/zeshel/w_scores_256 --encode_batch_size 256 --eval_batch_size 32 --top_k 256 --bert_model bert-base-cased --mode valid --zeshel True --data_parallel True --architecture special_tokens --cand_encode_path data/zeshel/cand_enc_base/cand_enc_valid.pt --cand_pool_path data/zeshel/cand_pool_base/cand_pool_valid.pt --cand_cls_path data/zeshel/cand_enc_base/cand_enc_valid_cls.pt --save_topk_result --split 2
python blink/biencoder/eval_biencoder.py --path_to_model /home/jongsong/BLINK/models/zeshel/biencoder_base/pytorch_model.bin --data_path data/zeshel/blink_format --output_path models/zeshel/w_scores_256 --encode_batch_size 256 --eval_batch_size 32 --top_k 256 --bert_model bert-base-cased --mode train --zeshel True --data_parallel True --architecture special_tokens --cand_encode_path data/zeshel/cand_enc_base/cand_enc_train.pt --cand_pool_path data/zeshel/cand_pool_base/cand_pool_train.pt --cand_cls_path data/zeshel/cand_enc_base/cand_enc_train_cls.pt --save_topk_result --split 5 
