...
python blink/biencoder/eval_biencoder.py --path_to_model /home/jongsong/BLINK/models/biencoder_wiki_large.bin --data_path data/zeshel/blink_format --output_path models/zeshel_large --encode_batch_size 256 --eval_batch_size 64 --top_k 64 --bert_model bert-large-uncased --mode valid,test --zeshel True --data_parallel True --architecture mlp_with_bert --save_topk_result 

# python blink/biencoder/eval_biencoder.py --path_to_model models/zeshel/biencoder/pytorch_model.bin --data_path data/zeshel/blink_format --output_path models/zeshel_test --encode_batch_size 512 --eval_batch_size 32 --top_k 64 --bert_model bert-base-cased --mode train --zeshel True --data_parallel True --architecture mlp_with_som --cand_pool_path data/zeshel/cand_pool --cand_encode_path data/zeshel/cand_enc --save_topk_result --split 5
