...
echo${"train"}
python blink/biencoder/eval_biencoder.py --data_path data/zeshel/blink_format --output_path models/zeshel_test --encode_batch_size 512 --eval_batch_size 32 --top_k 64 --bert_model bert-base-cased --mode train --zeshel True --data_parallel True --architecture mlp_with_som --cand_pool_path data/zeshel/cand_pool --save_topk_result --split 3
