...
python blink/biencoder/eval_biencoder.py --path_to_model /home/jongsong/BLINK/models/zeshel/biencoder/pytorch_model.bin --data_path data/zeshel/blink_format --output_path models/zeshel_test --encode_batch_size 512 --eval_batch_size 128 --top_k 64 --bert_model bert-base-cased --mode valid,test --zeshel True --data_parallel True --architecture mlp --cand_pool_path data/zeshel/cand_pool --cand_encode_path data/zeshel/cand_enc --save_topk_result 
