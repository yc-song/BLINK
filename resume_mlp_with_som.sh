...
wandb enabled
wandb online
python /home/jongsong/BLINK/blink/crossencoder/train_cross.py --architecture=mlp_with_som --decoder=False --dim_red=768 --layers=3 --learning_rate=0.0002987097419320384 --train_batch_size=8 --weight_decay=0.01 --cos_similarity --resume=True --run_id=t2fyz7w5                            
