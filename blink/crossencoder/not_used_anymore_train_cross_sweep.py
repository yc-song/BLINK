...
def main(params):
    ...
    params["learning_rate"] = wandb.config.learning_rate
    params["scheduler_gamma"] = wandb.config.scheduler_gamma
    params[""]
    ...
    if params["architecture"] == "mlp":
        ...
        scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=10, gamma=scheduler_gamma)
